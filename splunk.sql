...
CREATE OR REPLACE VIEW public.splunkconnection AS 
 SELECT scan.scancompletedon,
	...
	scanconnectioninstance.localaddr as src_ip,
	scanconnectioninstance.localport as src_port,
	scanconnectioninstance.remoteaddr as dest_ip,
    scanconnectioninstance.remoteport as dest_port,
    scanconnectioninstance.proto as protocol,
